...
Button mButtonMaps;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mButtonGrafic = findViewById(R.id.grafic);
mButtonMaps = findViewById(R.id.maps);
        ...
        mButtonGrafic.setOnClickListener(new View.OnClickListener() {
...
startActivity(intent);
    ...
    private  void Grafintent(){
        Intent intent = new Intent(Main2Activity.this,GraficActivity.class);
              startActivity(intent);
